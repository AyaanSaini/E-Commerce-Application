...
<!-- <div class="close"><a href="/Git_punjabi_Fashion/"><span class="glyphicon glyphicon-remove-sign"></span></a></div> -->
  ...
  <form action="${pageContext.request.contextPath}/Signup" method="post" id="signup">
    ...
    <div class='form-display'>
    	<div class="row">
    		<div class="col-md-6">
    			<button type="button" class="btn btn-primary" onclick="validateUser('signup')" >Signup</button>
    		</div>
    		<div class="col-md-6">
